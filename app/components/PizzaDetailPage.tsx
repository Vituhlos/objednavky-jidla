      ...
      <main className="flex-1 overflow-y-auto scroll-area p-4 md:p-5 space-y-4 pb-28 md:pb-8">
        ...
        <section className="glass rounded-3xl overflow-hidden">
          ...
          {rows.length === 0 ? (
            ...
            <>
              <div className="hidden md:grid gap-3 px-4 py-1.5 border-b border-white/30 font-display text-[10px] uppercase tracking-wide text-slate-500 font-semibold" style={{ gridTemplateColumns: "28px 1fr 2fr 60px 80px 80px", background: "rgba(255,255,255,0.3)" }}>
                <span>#</span>
                <span>Jméno</span>
                <span>Pizza</span>
