...
/**
 * Jedno oddělení v seznamu — čtecí řádek, který se na požádání překlopí do
 * formuláře.
 *
 * Rozepsané hodnoty žijí uvnitř řádku a ukládají se až tlačítkem, takže
 * „Zrušit“ je vrátí zpátky na to, co přišlo ze serveru. Mazání se ptá,
 * protože oddělení je jen měkce smazané, ale z pohledu operátora nevratně.
 */
