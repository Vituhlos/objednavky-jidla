    ...
    <>
      <SettingsSection icon="local_pizza" title="Pizza modul">
        <p className="text-[12.5px] text-stone-500">
          Modul Pizza přidá do aplikace stránku Pizza, sekci v Historii a vlastní příkazy v Telegram botovi. Po vypnutí se vše skryje a ceník pizzerie se nenačítá. Uložené objednávky zůstanou.
        </p>
